...
@receptionist_bp.route('/new-booking')
@login_required
@role_required('receptionist')
def new_booking():
    """Create a new booking."""
    return jsonify({
        "message": "New Booking - Not yet implemented"
    })


@receptionist_bp.route('/search-guest')
@login_required
@role_required('receptionist')
def search_guest():
    """Search for a guest."""
    return jsonify({
        "message": "Guest Search - Not yet implemented"
    })
...
def room_availability():
    ...
    return jsonify({
        "message": "Room Availability - Not yet implemented"
    })
